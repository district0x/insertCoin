...
contract MVPCLR is OwnableUpgradeable {
    ...
    // Increment the tournamentId for each new tournament
    uint256 newTournamentId = ++tournamentId;
    ...
    require(_tournamentId > 0 && _tournamentId <= tournamentId, "Tournament does not exist.");
